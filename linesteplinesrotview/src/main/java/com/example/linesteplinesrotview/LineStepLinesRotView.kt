package com.example.linesteplinesrotview
...
class LineStepLinesRotView(ctx : Context) : View(ctx) {
    ...
    data class LineStepLinesRot(var i : Int) {
    ...
    companion object {
        ...
        fun create(activity : Activity) : LineStepLinesRotView {
            val view : LineStepLinesRotView = LineStepLinesRotView(activity)
