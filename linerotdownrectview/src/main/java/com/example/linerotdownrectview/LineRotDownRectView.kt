package com.example.linerotdownrectview
...
fun Canvas.drawLineRotDownRect(scale : Float, w : Float, h : Float, paint : Paint) {
...
class LineRotDownRectView(ctx : Context) : View(ctx) {
    ...
    data class LineRotDownRect(var i : Int) {
    ...
    data class Renderer(var view : LineRotDownRectView) {

        private val animator : Animator = Animator(view)
        private val lrdr : LineRotDownRect = LineRotDownRect(0)
