package com.example.linesqrightdownview
...
fun Canvas.drawLineSqRightDown(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawLSRDNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawLineSqRightDown(scale, w, h, paint)
}

class LineSqRightDownView(ctx : Context) : View(ctx) {
    ...
    data class LSRDNode(var i : Int, val state : State = State()) {
    ...
    data class LineSqRightDown(var i : Int) {
    ...
    data class Renderer(var view : LineSqRightDownView) {

        private val animator : Animator = Animator(view)
        private val lsrd : LineSqRightDown = LineSqRightDown(0)
