package com.example.multilinerotgapview
...
class MultiLineRotGapView(ctx : Context) : View(ctx) {
    ...
    data class MultiLineRotGap(var i : Int) {

        private var curr : MLRGNode = MLRGNode(0)
