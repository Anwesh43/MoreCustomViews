package com.example.bilinerotrightview
...
fun Canvas.drawBiLineRight(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawBLRRNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawBiLineRight(scale, w, h, paint)
}

class BiLineRotRightView(ctx : Context) : View(ctx) {
    ...
    data class BiLineRotRight(var i : Int) {

        private var curr : BLRRNode = BLRRNode(0)
    ...
    companion object {
        ...
        fun create(activity : Activity) : BiLineRotRightView {
            val view : BiLineRotRightView = BiLineRotRightView(activity)
