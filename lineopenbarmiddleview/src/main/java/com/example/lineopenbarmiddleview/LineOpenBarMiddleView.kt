...
class LineOpenBarMiddleView(ctx : Context) : View(ctx) {
    ...
    data class LineOpenBarMiddle(var i : Int) {

        private var curr : LOBMNode = LOBMNode(0)
    ...
    companion object {
        ...
        fun create(activity : Activity) : LineOpenBarMiddleView {
            val view : LineOpenBarMiddleView = LineOpenBarMiddleView(activity)
