...
fun Canvas.drawLineBatBall(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawLBBNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawLineBatBall(scale, w, h, paint)
}

class LineBatBallView(ctx : Context) : View(ctx) {
    ...
    data class LineBatBall(var i : Int) {
