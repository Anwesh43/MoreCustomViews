...
class LineRotArcRightView(ctx : Context) : View(ctx) {
    ...
    data class LineRotArcRight(var i : Int, val state : State = State()) {
    ...
    data class Renderer(var view : LineRotArcRightView, val paint : Paint = Paint(Paint.ANTI_ALIAS_FLAG)) {
