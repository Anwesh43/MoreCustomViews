package com.example.linearcfilldivideview
...
fun Canvas.drawLineArcDivide(scale  : Float, w : Float, h : Float, paint : Paint) {
    val dsc : (Int) -> Float = {
...
fun Canvas.drawLADNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawLineArcDivide(scale, w, h, paint)
}
...
class LineArcDivideView(ctx : Context) : View(ctx) {
    ...
    data class LineArcDivide(var i : Int) {
    ...
    companion object {
        ...
        fun create(activity : Activity) : LineArcDivideView {
            val view : LineArcDivideView = LineArcDivideView(activity)
