package com.example.linearcbendrightview
...
fun Canvas.drawLineArcBendRight(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawLABRNode(i : Int, scale : Float, paint : Paint) {
...
class LineArcBendRightView(ctx : Context) : View(ctx) {
    ...
    data class LABRNode(var i : Int = 0, val state : State = State()) {

        private var next : LABRNode? = null
        private var prev : LABRNode? = null
        ...
        fun draw(canvas : Canvas, paint : Paint) {
            canvas.drawLABRNode(i, state.scale, paint)
        }
        ...
        fun getNext(dir : Int, cb : () -> Unit) : LABRNode {
            var curr : LABRNode? = prev
            if (dir == 1) {
                curr = next
            }
            if (curr != null) {
    ...
    data class LineArcBendRight(var i : Int) {

        private var curr : LABRNode = LABRNode(0)
