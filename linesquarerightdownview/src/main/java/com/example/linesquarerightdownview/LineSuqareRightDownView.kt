package com.example.linesquarerightdownview
...
fun Canvas.drawLineSquareRightDown(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawLSRDNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawLineSquareRightDown(scale, w, h, paint)
}

class LineSquareRightDownView(ctx : Context) : View(ctx) {
    ...
    data class LineSquareRightDown(var i : Int) {
    ...
    data class Renderer(var view : LineSquareRightDownView) {

        private val animator : Animator = Animator(view)
        private val lsrd : LineSquareRightDown = LineSquareRightDown(0)
