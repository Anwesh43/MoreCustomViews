package com.example.linebarbentview
...
fun Canvas.drawLineBarBent(scale : Float, w : Float, h : Float, paint : Paint) {
    val dsc : (Int) -> Float = {
...
fun Canvas.drawLBBNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawLineBarBent(scale, w, h, paint)
}

class LineBarBentView(ctx : Context) : View(ctx) {
    ...
    data class LBBNode(var i : Int = 0, val state : State = State()) {
    ...
    data class LineBarBent(var i : Int) {
