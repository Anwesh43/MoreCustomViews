package com.example.mirrorrotlineview
...
fun Canvas.drawMirrorRotLine(scale : Float, w : Float, h : Float, paint : Paint) {
...
class MirrorRotLineView(ctx : Context) : View(ctx) {
    ...
    data class MRLNode(var i : Int = 0, val state : State = State()) {
    ...
    data class MirroRotLine(var i : Int) {
