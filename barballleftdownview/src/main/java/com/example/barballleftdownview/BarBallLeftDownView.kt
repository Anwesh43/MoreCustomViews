package com.example.barballleftdownview
...
fun Canvas.drawBarBallLeftDown(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawBBLDNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawBarBallLeftDown(scale, w, h, paint)
}

class BarBallLeftDownView(ctx : Context) : View(ctx) {
    ...
    data class BBLDNode(var i : Int = 0, val state : State = State()) {
    ...
    data class BarBallLeftDown(var i : Int) {

        private var curr : BBLDNode = BBLDNode(0)
