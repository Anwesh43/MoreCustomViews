package com.example.bowcreatorrotview
...
fun Canvas.drawBowCreatorRot(scale : Float, w : Float, h : Float, paint : Paint) {
...
class BowCreatorRotView(ctx : Context) : View(ctx) {
    ...
    data class BCRNode(var i : Int = 0, val state : State = State()) {
    ...
    data class BowCreatorRot(var i : Int) {

        private var curr: BCRNode = BCRNode(0)
    ...
    companion object {
        ...
        fun create(activity : Activity) : BowCreatorRotView {
            val view : BowCreatorRotView = BowCreatorRotView(activity)
