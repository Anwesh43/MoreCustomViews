package com.example.fillarclinerightview
...
fun Canvas.drawFillArcLineRight(scale : Float, w : Float, h : Float, paint : Paint) {
...
class FillArcLineRightView(ctx : Context) : View(ctx) {
    ...
    data class FillArcLineRotRight(var i : Int) {
    ...
    data class Renderer(var view : FillArcLineRightView) {

        private val animator : Animator = Animator(view)
        private val falr : FillArcLineRotRight = FillArcLineRotRight(0)
