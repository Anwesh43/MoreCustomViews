...
class ShooterMidLineView(ctx : Context) : View(ctx) {
    ...
    data class ShooterMidLine(var i : Int) {

        private var curr : SMLNode = SMLNode(0)
    ...
    companion object {
        ...
        fun create(activity : Activity) : ShooterMidLineView {
            val view : ShooterMidLineView = ShooterMidLineView(activity)
